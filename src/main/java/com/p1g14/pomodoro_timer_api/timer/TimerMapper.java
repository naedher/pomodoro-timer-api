...
public class TimerMapper {
     ...
     * @return a TimerDetailsResponse object
     */
    ...
    /**
     * Map the fields of a TimerUpdateRequest onto a Timer entity
     * @param request the TimerUpdateRequest
     * @param timer the Timer entity
     * @return an updated Timer
     */
